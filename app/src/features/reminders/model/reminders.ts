...
import {
  ReminderKind as ReminderKindValues,
  ReminderScheduleType as ReminderScheduleTypeValues,
} from "../../../lib/api/operations";
...
export const ReminderKindConst = ReminderKindValues;
export const ReminderScheduleTypeConst = ReminderScheduleTypeValues;

export function kindLabel(kind: ReminderKind, scheduleType?: ReminderScheduleType | null) {
...
export function buildCreateReminderRequest(form: ReminderFormState): CreateReminderRequest {
  return {
    ...
    endDate: isRecurringReminder(form) && form.endDate !== "" ? form.endDate : undefined,
  };
}

export function buildUpdateReminderRequest(form: ReminderFormState): UpdateReminderRequest {
  return {
    title: form.title.trim(),
    ...
    endDate: isRecurringReminder(form) ? (form.endDate === "" ? null : form.endDate) : null,
  };
}
