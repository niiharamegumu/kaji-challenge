...
export function patchTask(
  ...
  return callOperation("patchTask", { params: { taskId }, body }, 200, options);
}
export function deleteTask(
  taskId: string,
  options?: CallOptions,
): Promise<ApiResult<Record<string, never>>> {
  return callOperation("deleteTask", { params: { taskId } }, 204, options);
}
export function postTaskCompletion(
  taskId: string,
  body: M.TaskCompletionRequest,
  options?: CallOptions,
): Promise<ApiResult<M.TaskCompletionResponse>> {
  return callOperation("postTaskCompletion", { params: { taskId }, body }, 200, options);
}
export function listReminders(
  params: { from: string; to: string },
  options?: CallOptions,
): Promise<ApiResult<M.ReminderCalendarResponse>> {
  return callOperation("listReminders", { params: { ...params } }, 200, options);
}
export function postReminder(
  body: M.CreateReminderRequest,
  options?: CallOptions,
): Promise<ApiResult<M.Reminder>> {
  return callOperation("postReminder", { params: {}, body }, 201, options);
}
export function listReminderDefinitions(
  options?: CallOptions,
): Promise<ApiResult<M.ReminderListResponse>> {
  return callOperation("listReminderDefinitions", { params: {} }, 200, options);
}
export function patchReminder(
  ...
  return callOperation("patchReminder", { params: { reminderId }, body }, 200, options);
}
export function deleteReminder(
  reminderId: string,
  options?: CallOptions,
): Promise<ApiResult<Record<string, never>>> {
  return callOperation("deleteReminder", { params: { reminderId } }, 204, options);
}
export function listPenaltyRules(
  params?: { includeDeleted?: boolean },
  options?: CallOptions,
): Promise<ApiResult<{ items: M.PenaltyRule[] }>> {
  return callOperation("listPenaltyRules", { params: { ...params } }, 200, options);
}
export function postPenaltyRule(
  body: M.CreatePenaltyRuleRequest,
  options?: CallOptions,
): Promise<ApiResult<M.PenaltyRule>> {
  return callOperation("postPenaltyRule", { params: {}, body }, 201, options);
}
export function patchPenaltyRule(
  ...
  return callOperation("patchPenaltyRule", { params: { ruleId }, body }, 200, options);
}
...
export function getPenaltySummaryMonthly(
  ...
  return callOperation("getPenaltySummaryMonthly", { params: { ...params } }, 200, options);
}
export function getMonthCloseCandidate(
  options?: CallOptions,
): Promise<ApiResult<M.MonthCloseCandidateResponse>> {
  return callOperation("getMonthCloseCandidate", { params: {} }, 200, options);
}
export function postMonthClose(
  month: string,
  options?: CallOptions,
): Promise<ApiResult<M.CloseResponse>> {
  return callOperation("postMonthClose", { params: { month } }, 200, options);
}
