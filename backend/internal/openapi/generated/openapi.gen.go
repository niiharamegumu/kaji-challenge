...
// Valid indicates whether the value is a known member of the PushPlatform enum.
func (e PushPlatform) Valid() bool {
	switch e {
	case IosSafariPwa:
		return true
	default:
...
// Valid indicates whether the value is a known member of the ReminderScheduleType enum.
func (e ReminderScheduleType) Valid() bool {
	switch e {
	case ReminderScheduleTypeDaily:
		return true
	case ReminderScheduleTypeMonthly:
		return true
	case ReminderScheduleTypeWeekly:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ToggleTaskCompletionRequestAction enum.
func (e ToggleTaskCompletionRequestAction) Valid() bool {
	switch e {
	case Complete:
		return true
	case Decrement:
...
func (siw *ServerInterfaceWrapper) DeletePenaltyRule(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "ruleId", c.Param("ruleId"), &ruleId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeletePushSubscription(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "subscriptionId", c.Param("subscriptionId"), &subscriptionId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeleteReminder(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "reminderId", c.Param("reminderId"), &reminderId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) DeleteShoppingItem(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "itemId", c.Param("itemId"), &itemId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
