  ...
  if (isMobile) {
    return createPortal(
      <>
        ...
        <dialog
          open
          className="fixed bottom-[94px] left-1/2 z-[73] w-[min(92vw,30rem)] -translate-x-1/2 overflow-hidden rounded-[1.8rem] border border-white/40 bg-[linear-gradient(180deg,rgba(255,255,255,0.56),rgba(246,241,232,0.36))] p-4 shadow-[0_24px_48px_-30px_rgba(68,56,36,0.42),inset_0_1px_0_rgba(255,255,255,0.62)]"
          style={{
          ...
          <div className="mt-5 flex items-center justify-between gap-3">
            <div>
              {onDelete != null ? (
                <button
                  type="button"
                  className="inline-flex h-10 items-center gap-1 rounded-xl border border-rose-300 bg-rose-50/82 px-3 text-sm text-rose-700 transition-colors hover:bg-rose-100"
                  onClick={onDelete}
                >
