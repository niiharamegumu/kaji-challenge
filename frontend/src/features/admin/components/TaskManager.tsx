  ...
  return (
    <article className="rounded-2xl border border-stone-200 bg-white/90 p-4 shadow-sm animate-enter">
      ...
      <div className="mt-3 grid gap-2">
        ...
        />
        <div
          className={`grid gap-2 pr-1 ${form.type === TaskTypeConst.weekly ? "grid-cols-1 md:grid-cols-3" : "grid-cols-1 md:grid-cols-2"}`}
        >
          <div className="grid min-w-0 gap-1">
            ...
            <select
              id="task-type"
              className="h-14 w-full rounded-lg border border-stone-300 px-3 py-2"
              value={form.type}
